...
public class ProjectApplication {
	...
	public CommandLineRunner bookDemo(GameRepository grepository, CategoryRepository crepository, UserRepository urepository) {
		return (args) -> {
			...
			grepository.save(new Game("My Time as Sandrock", "Pathea Games", crepository.findByName("Simulation")));
			...
			User user1 = new User("Claudia", "$2a$10$vOuq3lQ72pGTY1Z9jYsWIOEI2V.U3KutX/MVjIpiHoMCO05JSPAHi", "USER");
			User user2 = new User("admin", "$2a$10$FmaBsX8tlB4gsiKwMVobae0MhjZ17mo3NVzatea8YqxDxOu4PA8yO", "ADMIN");
			//2 premade users
